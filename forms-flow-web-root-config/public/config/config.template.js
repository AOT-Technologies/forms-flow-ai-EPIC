...
/*  //TODO Remove the MF variables from config.js Not being used anywhere as these are build time variable
  ...
  MF_FORMSFLOW_REVIEW_URL: "${MF_FORMSFLOW_REVIEW_URL}",
  MF_FORMSFLOW_SUBMISSIONS_URL: "${MF_FORMSFLOW_SUBMISSIONS_URL}", 
  */
  ...
  // Form-IO DEFAULT-PROJECT-URL
  REACT_APP_FORMIO_DEFAULT_PROJECT_URL: "${REACT_APP_FORMIO_DEFAULT_PROJECT_URL}",
  ...
  REACT_APP_USER_NAME_DISPLAY_CLAIM: "${REACT_APP_USER_NAME_DISPLAY_CLAIM}",
  REACT_APP_ENABLE_COMPACT_FORM_VIEW: "${REACT_APP_ENABLE_COMPACT_FORM_VIEW}",
  REACT_APP_GRAPHQL_API_URL: "${REACT_APP_GRAPHQL_API_URL}",
  // SMART on FHIR / Epic EHR Configuration
  REACT_APP_SMART_CLIENT_ID: "${REACT_APP_SMART_CLIENT_ID}",
  REACT_APP_SMART_REDIRECT_URI: "${REACT_APP_SMART_REDIRECT_URI}",
  REACT_APP_SMART_SCOPE: "${REACT_APP_SMART_SCOPE}",
  // Epic-launch -> Keycloak handoff (see keycloakHandoff.js)
  REACT_APP_EHR_CONNECTOR_URL: "${REACT_APP_EHR_CONNECTOR_URL}",
  REACT_APP_KEYCLOAK_EPIC_REALM_URL: "${REACT_APP_KEYCLOAK_EPIC_REALM_URL}",
  REACT_APP_KEYCLOAK_EPIC_CLIENT_ID: "${REACT_APP_KEYCLOAK_EPIC_CLIENT_ID}",
  REACT_APP_EHR_DEBUG: "${REACT_APP_EHR_DEBUG}"
};
